...
import { queryFakeItem, fakeSubmitAttributeRelease, removeFakeItem, saveOrUpdateConfluence } from '../add/service';
import type { StepDataType } from './data';


const Page: React.FC = (props) => {
  const [stepData, setStepData] = useState<StepDataType>({ type: 'Confluence' });
