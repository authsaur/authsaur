...
import { queryFakeItem, removeFakeItem, saveOrUpdateSeafile, fakeSubmitAttributeRelease } from '../add/service';
import type { StepDataType } from './data';


const Page: React.FC = (props) => {
  const [stepData, setStepData] = useState<StepDataType>({ type: 'Seafile' });
              ...
              children: <>
                <ProForm
                  ...
                  onFinish={async (values) => {
                    const response = await saveOrUpdateSeafile({
