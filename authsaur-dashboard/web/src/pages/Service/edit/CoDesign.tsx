...
import { queryFakeItem, removeFakeItem, saveOrUpdateCodesign, fakeSubmitAttributeRelease } from '../add/service';
import type { StepDataType } from './data';


const Page: React.FC = (props) => {
  const [stepData, setStepData] = useState<StepDataType>({ type: 'Codesign' });
              ...
              children: <>
                <ProForm
                  ...
                  onFinish={async (values) => {
                    const response = await saveOrUpdateCodesign({
