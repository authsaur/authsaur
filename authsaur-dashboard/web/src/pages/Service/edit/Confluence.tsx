...
import { queryFakeItem, fakeSubmitAttributeRelease, removeFakeItem, saveOrUpdateJira } from '../add/service';
import type { StepDataType } from './data';


const Page: React.FC = (props) => {
  const [stepData, setStepData] = useState<StepDataType>({ type: 'Jira' });
