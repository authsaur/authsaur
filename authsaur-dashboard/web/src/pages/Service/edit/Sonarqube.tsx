...
import { ProFormItem, ProFormText, ProFormTextArea, StepsForm } from '@ant-design/pro-form';
...
import { queryFakeItem, fakeSubmitAttributeRelease, removeFakeItem, saveOrUpdateSonarqube } from '../add/service';
import type { StepDataType } from './data';


const Page: React.FC = (props) => {
  const [stepData, setStepData] = useState<StepDataType>({ type: 'Sonarqube' });
  ...
  React.useEffect(() => {
    ...
    queryFakeItem(id).then(function (resp) {
      ...
      formRef.current?.setFieldsValue({
        ...
        applicationId: response?.appConfig?.applicationId,
