...
import { queryFakeItem, removeFakeItem, saveOrUpdateGrafana, fakeSubmitAttributeRelease } from '../add/service';
import type { StepDataType } from './data';


const Page: React.FC = (props) => {
  const [stepData, setStepData] = useState<StepDataType>({ type: 'Grafana' });
